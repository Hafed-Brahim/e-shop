...
export function* getUserAuthSnapshot(userAuth, addictionalData) {
    try {

        const userRef = yield call(createUserProfileDocument, userAuth, addictionalData);
